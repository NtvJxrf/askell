const Calculate = (data, selfcost) => {
    const { material, height, width, cuts, smdType, color, rounds, drillssmd, print, notax, quantity = 1 } = data // Всегда закаленное, нужно для корректного создания пз
    data.tempered = true
    ...
    const stanok = (straightTypes.includes(smdType) && larger > 2500 && cuts == 0) ? 'Прямолинейка' : 'Криволинейка'
